...
public class BusanAvgDataConsumer {
    ...
    private static final String TOPIC_NAME = "busan_avg7";
    ...
    public static void main(String[] args) {
        ...
        props.put(ConsumerConfig.GROUP_ID_CONFIG, "busan-avg7-group");
        ...
        try {
            while (true) {
                ...
                for (ConsumerRecord<String, Object> record : records) {
                    ...
                    // JSON 데이터에서 평균 온도 추출 (예: {"BUSAN_AVG_UPS_TEMP": 38.5, "COUNT": 88, ...})
